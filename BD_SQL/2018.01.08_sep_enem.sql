...
--
-- Host: 127.0.0.1
-- Generation Time: 08-Jan-2018 às 14:56
...
--
ALTER TABLE `alternativa`
MODIFY `idAlternativa` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `questao`
MODIFY `idQuestao` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `simulado`
--
ALTER TABLE `simulado`
MODIFY `idSimulado` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
